...
from document_classification.common.trainers.trainer import Trainer
...
class ClassificationTrainer(Trainer):
    ...
    def train(self, epochs):
        ...
        for epoch in range(1, epochs + 1):
            ...
            dev_acc, dev_precision, dev_recall, dev_f1_micro, dev_f1_macro, dev_f1_weighted, dev_loss, _ = self.dev_evaluator.get_scores()[0]

            # Print validation results
            print('\n' + dev_header)
            print(self.dev_log_template.format(time.time() - self.start, epoch, self.iterations, epoch, epochs,
                                               dev_acc, dev_precision, dev_recall, dev_f1_micro, dev_f1_macro, dev_f1_weighted, dev_loss))

            # Update validation results
            if dev_f1_weighted > self.best_dev_f1:
                self.iters_not_improved = 0
                self.best_dev_f1 = dev_f1_weighted
