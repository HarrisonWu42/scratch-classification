...
import torch
import torch.onnx
from document_classification.common.evaluate import EvaluatorFactory
from document_classification.common.train import TrainerFactory
from document_classification.datasets.scratch import Scratch
from document_classification.models.kim_cnn.args import get_args
from document_classification.models.kim_cnn.model import KimCNN
...
if __name__ == '__main__':
    ...
    args.seed = 1234
    args.mode = 'static'
    args.dataset = 'Scratch'
    args.batch_size = 32
    args.lr = 0.01
    args.epochs = 30
    args.dropout = 0.5

    args.data_dir = '/home/wh/Project/covid19-classification/hedwig-data/datasets'
    args.word_vectors_dir = '/home/wh/Project/covid19-classification/hedwig-data/embeddings/word2vec'
    args.word_vectors_file = 'GoogleNews-vectors-negative300.txt'
